        ...
        <div class="vcard-one main-content  w-100 mx-auto content-blur allSection collapse show">
            ...
            @if (!empty($userSetting['enable_affiliation']))
                <div class="container mb-10">
                    ...
                    <div class="bg-body p-4 border border-primary text-center rounded mb-20">
                            ...
                            <div class="modal-body">
                                <a href="http://www.facebook.com/sharer.php?u={{ $shareUrl }}" target="_blank"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 p-1">
                                            <p class="align-items-center text-dark">{{ __('messages.social.Share_on_facebook') }}</p>
                                        </div>
                                        <div class="col-1 p-1">
                                ...
                                <a href="http://twitter.com/share?url={{ $shareUrl }}&text={{ $vcard->name }}&hashtags=sharebuttons"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 p-1">
                                            <p class="align-items-center text-dark">{{ __('messages.social.Share_on_twitter') }}</p>
                                        </div>
                                        <div class="col-1 p-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="16px"
                                                viewBox="0 0 512.000000 512.000000"
                                ...
                                <a href="http://www.linkedin.com/shareArticle?mini=true&url={{ $shareUrl }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 p-1">
                                            <p class="align-items-center text-dark">{{ __('messages.social.Share_on_linkedin') }}</p>
                                        </div>
                                        <div class="col-1 p-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="16px"
                                                viewBox="0 0 512.000000 512.000000"
                                ...
                                <a href="mailto:?Subject=&Body={{ $shareUrl }}" target="_blank"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 p-1">
                                            <p class="align-items-center text-dark">{{ __('messages.social.Share_on_email') }}</p>
                                        </div>
                                        <div class="col-1 p-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="16px"
                                                viewBox="0 0 512.000000 512.000000"
                                ...
                                <a href="http://pinterest.com/pin/create/link/?url={{ $shareUrl }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 p-1">
                                            <p class="align-items-center text-dark">{{ __('messages.social.Share_on_pinterest') }}</p>
                                        </div>
                                        <div class="col-1 p-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="16px"
                                                viewBox="0 0 512.000000 512.000000"
                                ...
                                <a href="http://reddit.com/submit?url={{ $shareUrl }}&title={{ $vcard->name }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 p-1">
                                            <p class="align-items-center text-dark">{{ __('messages.social.Share_on_reddit') }}</p>
                                        </div>
                                        <div class="col-1 p-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="16px"
                                                viewBox="0 0 512.000000 512.000000"
                                ...
                                <a href="https://wa.me/?text={{ $shareUrl }}" target="_blank"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-9 p-1">
                                            <p class="align-items-center text-dark">{{ __('messages.social.Share_on_whatsapp') }}</p>
                                        </div>
                                        <div class="col-1 p-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" height="16px"
                                                viewBox="0 0 512.000000 512.000000"
