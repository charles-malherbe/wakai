    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-gray-200">
                ...
                <div class="card flex-sm-row">
                    ...
                    <div class="card-body px-0">
                        <div class="profile-name">
                            <h2 class="font-DM-Serif-Display text-white fs-30">
                        ...
                        <div class="col-sm-6 mb-40">
                            <div class="contact-box">
                                ...
                                <div class="contact-desc">
                                    <p class="text-gray-100 mb-0 fs-14">{{ __('messages.vcard.email_address') }}</p>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pb-40 px-30">
            ...
            @if (checkFeature('services') && $vcard->services->count())
                <div class="our-services-section px-30 pt-20 pb-40">
                    <div class="section-heading text-center overflow-hidden">
                        <h2 class="font-DM-Serif-Display text-white mb-0 d-inline-block">
            ...
            @if (checkFeature('products') && $vcard->products->count())
                <div class="product-section bg-gray pb-40 px-3">
                    <div class="section-heading overflow-hidden mx-3">
                        ...
                        <a class="fs-5 mb-0" href="{{ route('showProducts',['id'=>$vcard->id,'alias'=>$vcard->url_alias]) }}">{{__('messages.analytics.view_more')}}</a>
                        </div>
                    </div>
                            ...
                            <div class="">
                                ...
                                <div class="product-card card">
                                    <div class="product-img card-img">
                                        <img src="{{ $product->product_icon }}" class="img-fluid h-100 w-100" />
                                    </div>
                                ...
                                <div class="blog-card blog-1 card">
                                    <div class="overlay">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-end">
                                            <h6 class="card-title text-white fw-5 fs-20">{{ $blog->title }}</h6>
            ...
            @if ($vcard->businessHours->count())
                ...
                @endphp
                <div class="bussiness-hour-section pt-30 pb-80 px-30">
                    <div class="section-heading text-center overflow-hidden">
                        <h2 class="font-DM-Serif-Display text-white mb-0 d-inline-block">
            ...
            @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                <div class="appointment-section pt-3 mt-1 px-30">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pt-60 pb-60 px-30">
                    <div class="section-heading text-center overflow-hidden">
                        <h2 class="font-DM-Serif-Display text-white mb-0 d-inline-block">
            ...
            @if (!empty($userSetting['enable_affiliation']))
                {{-- create vcard --}}
                <div class="create-vcard-section pb-40 mb-4 px-30">
                    <div class="section-heading overflow-hidden">
                        <h2 class="font-DM-Serif-Display text-white mb-0 d-inline-block">
