                            ...
                            <div class="col-12 px-0">
                                <form id="enquiryForm">
                                    ...
                                    <div class="contact-form px-sm-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">{{ __('messages.user.your_name') }} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">{{ __('messages.user.email') }} <span class="text-danger">*</span></label>
                                            <div class="input-group mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label">{{ __('messages.user.your_message') }} <span class="text-danger">*</span></label>
